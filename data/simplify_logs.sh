...
./simplify_logs.py "$log_path" -o "${base_newfile}_loadgraph.png"
./simplify_logs.py "$log_path" -f -o "${base_newfile}_loadgraph_f.png"
./simplify_logs.py "$log_path" -s -o "${base_newfile}_loadgraph_s.png"
./simplify_logs.py "$log_path" -m EBB -o "${base_newfile}_loadgraph_EBB.png"
./simplify_logs.py "$log_path" -m rpi -o "${base_newfile}_loadgraph_rpi.png"
./simplify_logs.py "$log_path" -m scanner -o "${base_newfile}_loadgraph_scanner.png"
